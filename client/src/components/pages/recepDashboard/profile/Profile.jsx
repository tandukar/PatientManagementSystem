...
import {
  useRecepDetailQuery,
  useUpdatePasswordRecepMutation,
} from "../RecepApiSlice";
...
const Profile = () => {
  ...
  const { data: userDetail = [] } = useRecepDetailQuery(recepId);
  const [updatePasswordRecep, { isLoading, error }] = useUpdatePasswordRecepMutation();
